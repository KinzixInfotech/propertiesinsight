                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-8 items-center">
                        ...
                        >
                            ...
                            {/* Subtitle */}
                            <h2 className="text-xl sm:text-2xl lg:text-3xl font-light mb-8 text-gray-200">
                                {siteContent.hero.subtitle}
                            </h2>

                            {/* Features - Show only first 4 on desktop */}
                            <div className="grid grid-cols-1 gap-3 mb-8">
                                {siteContent.hero.features.slice(0, 4).map((feature, i) => (
                                    <motion.div
                                        key={i}
                                        initial={{ opacity: 0, y: 20 }}
                                        animate={{ opacity: 1, y: 0 }}
                                        transition={{ delay: 0.5 + i * 0.1, duration: 0.6 }}
                                        className="flex items-start gap-3 bg-white/5 backdrop-blur-sm p-3 rounded-lg border border-white/10"
                                    >
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="bg-white text-gray-900 px-6 py-3 rounded-lg text-base font-semibold hover:bg-gray-100 transition-all shadow-lg flex items-center gap-2"
                                >
                                    <span className="text-sm text-gray-500 line-through">₹38,000</span>
                                    <span className="text-lg font-bold text-[#165dfc]">₹36,000</span>
                                </button>
                                ...
                                <button
                                    ...
                                    className="bg-gray-900/50 backdrop-blur-sm text-white px-6 py-3 rounded-lg text-base font-semibold hover:bg-gray-900/70 transition-all border border-white/20"
                                >
                                    Call Now
                                </button>
                            </motion.div>
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    ...
                                                    >
                                                        ...
                                                        <option value="150 Sq.Yard" className="bg-gray-900">150 Sq. Yard</option>
                                                        <option value="200 Sq.Yard" className="bg-gray-900">200 Sq. Yard</option>
